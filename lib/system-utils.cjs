...
function inspectEnginePaths({ engineRoot, runnerExists = false, installerExists = false, moduleInstalled = false, pythonExists = false, bootstrapAvailable = false, offlineMode = false, offlineBundleExists = false, wheelhouseExists = false, modelCacheExists = false }) {
  ...
  return {
    ...
    offlineBundleAvailable: Boolean(offlineBundleExists),
    wheelhouseAvailable: Boolean(wheelhouseExists),
    modelCacheAvailable: Boolean(modelCacheExists),
  };
}
